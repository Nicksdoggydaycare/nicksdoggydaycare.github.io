...
export default function App() {
  ...
  </main><footer className="footer"><div><p className="footer-brand">Nick's Doggy Daycare</p><p>Happy pets. Peace of mind.</p></div><div><p>Jacksonville & Ponte Vedra</p><p>Daycare · Boarding · At-Home Visits · Transportation</p></div><p>© {new Date().getFullYear()} Nick's Doggy Daycare</p></footer></>
}
